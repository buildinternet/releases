...
| `providers`            | Provider-detection table and hints (feed paths, crawl patterns, preferred source type). Supported platforms + how to add one: [provider-detection.md](../../docs/architecture/provider-detection.md). |

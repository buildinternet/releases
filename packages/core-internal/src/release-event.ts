/**
 * Wire shape for a `release.created` event — shared by the API event bus
 * (ReleaseHub DO + stream), release-fanout queue, and webhook delivery queue.
 *
 * Pure types + id helpers. No DO storage or D1.
 */

/**
 * Queue wire contract for one outbound webhook delivery attempt.
 * Produced by the API worker's fan-out; consumed by the webhooks worker.
 */

import type { WebhookFormat } from "@buildinternet/releases-core/schema";
import type { ReleaseEvent } from "./release-event.js";

...
describe("GET /v1/admin/cron-runs/:id", () => {
  ...
  it("inlines fetch-log status breakdown per session", async () => {
    ...
    db.insert(organizations).values({ id: "org_test", slug: "test-org", name: "Test Org", category: "developer-tools" }).run();
    db.insert(sources).values([
      { id: "src_1", slug: "s-1", name: "S1", type: "scrape", orgId: "org_test", url: "https://example.com/1" },
      { id: "src_2", slug: "s-2", name: "S2", type: "scrape", orgId: "org_test", url: "https://example.com/2" },
      { id: "src_3", slug: "s-3", name: "S3", type: "scrape", orgId: "org_test", url: "https://example.com/3" },
    ]).run();

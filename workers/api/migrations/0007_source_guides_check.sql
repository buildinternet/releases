-- Fix CHECK constraint on knowledge_pages.scope to allow 'source-guide'.
-- Must recreate the table since SQLite cannot ALTER CHECK constraints.
...
-- Recreate all indexes (they were lost when the old table was dropped)

...
import { knowledgePages, organizations, sources, products } from "@releases/db/schema.js";
...
// GET /guide?slug=<orgSlug> — get assembled source guide for an org
app.get("/", async (c) => {
...
// PATCH /guide/notes?slug=<orgSlug> — update source guide notes

...
The playbook header regenerates automatically after any source add/edit/remove, and the `--notes-file` PATCH seeds a fresh header on first write — no separate regenerate step needed.

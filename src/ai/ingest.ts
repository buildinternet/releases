...
- If a date is present, convert it to ISO 8601 format (YYYY-MM-DD or full datetime). For month-only dates (e.g. "April 2026"), use the first of the month: 2026-04-01. For year-only dates, use January 1. Approximate month/year dates are preferable to omitting publishedAt.

...
- **Cron and ingest activity:** operators can inspect recent cron runs and per-source fetch state through the internal dashboard at `/admin/status` (admin flag required).

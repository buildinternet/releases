...
export async function generateMetadata({
  ...
  try {
    ...
    return {
      title: `${org.name} Overview · ${currentPeriod()}`,
      description: `AI overview, release activity, and tracked sources for ${org.name} — updated ${currentPeriod()}.`,

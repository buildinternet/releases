    ...
    <div className="mt-4 pt-4 border-t border-stone-200 dark:border-stone-800 flex justify-center gap-2 text-sm">
      ...
      {pages.map((p) => (
        <Link
          ...
          className={
            p === page
              ? "font-semibold text-stone-900 dark:text-stone-100 bg-stone-100 dark:bg-stone-800 px-2 py-0.5 rounded"
              : "text-stone-500 hover:text-stone-700 dark:hover:text-stone-300 px-2 py-0.5"
          }
        >
          {p}
        </Link>

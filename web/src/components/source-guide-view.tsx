...
interface SourceGuideViewProps {
  guide: { content: string; updatedAt: string };
}
...
export function SourceGuideView({ guide }: SourceGuideViewProps) {
  const updatedDate = new Date(guide.updatedAt).toLocaleDateString("en-US", {
    month: "short",
    day: "numeric",
    year: "numeric",
    timeZone: "UTC",

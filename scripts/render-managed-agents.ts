...
import { buildWorkerSystemPrompt } from "@releases/agent-shared/worker-prompt";
import { buildCoordinatorSystemPrompt } from "@releases/agent-shared/coordinator-prompt";
import {
  AGENT_TOOLS,
  buildMcpToolset,
...
const HEADER =
  ...
  "# Source of truth: the prompt builders (packages/agent-shared/src/*-prompt.ts), AGENT_TOOLS\n" +
  "# (packages/agent-shared/src/agent-tools.ts), and skill IDs (scripts/agent-skills*.json).\n" +

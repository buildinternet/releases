...
- Shared RRF + provider abstraction: `src/lib/vector-search.ts`, `src/lib/embeddings.ts`
- Worker hybrid orchestrators: `workers/api/src/lib/search-hybrid.ts`, `workers/mcp/src/lib/search-hybrid.ts`
- Ingest helpers: `src/lib/embed-releases.ts`, `src/lib/embed-entities.ts`, `src/lib/embed-changelog-pipeline.ts`

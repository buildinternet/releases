...
| `semantic-alerts-enabled`              | `false` | api            | Semantic-alert preferences for signed-in users (/v1/me/semantic-alerts, #2304). Off = routes 404 and the account UI hides the section. Does not score or deliver matches.                                                      |

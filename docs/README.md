...
- **[semantic-alerts.md](architecture/semantic-alerts.md)** — freeform interest alerts (#2304): follows-only JEV matching, webhook and email delivery, and the account preference UI.

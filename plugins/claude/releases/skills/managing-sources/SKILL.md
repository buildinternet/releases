...
| Update org            | `releases admin org update <slug> [--name <n>] [--domain <d>] [--tier <t>] [--billing-customer-id <id>]`                          | `manage_org` action "edit" with identifier, name, domain, description, category                                                                                                                                             |
